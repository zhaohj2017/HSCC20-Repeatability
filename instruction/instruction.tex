...
\begin{verbatim}              
        python main.py
\end{verbatim}
to obtain a generated barrier certificate and a pre-trained model which will be store in the 
...
\begin{verbatim}              
        python main.py
\end{verbatim}
again to obtain a generated barrier certificate and a fine-tuned model which will be store in the 
\textsf{pre-trained.pt} file in the current directory. At the same time, a picture similar to
