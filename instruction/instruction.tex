...
We have tested \textsf{nnbarrier} on Ubuntu Linux, Mac OS, and Windows.
...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|c|c|c|} 
		...
		\hline Ubuntu~TBD         & TBD       & 19.3.1   & TBD     & \\ 
		\hline Ubuntu~18.04.02    & 3.6.9     & 19.3.1   & 1.3.1   &   \\ 
		\hline Mac~OS~10.11.6     & 3.7.6     & 19.3.1   & 1.3.1   &  \\ 
		\hline Windows~10~1903    & 3.7.3     & 19.3.1   & 1.3.1   &  \\
		\hline
	\end{tabular}
\end{table}

\textsf{Ubuntu~18.04.02+Python~3.6.9}, \textsf{Mac~OS~10.11.6+Python~3.7.6}, 
and \textsf{Windows~10~1903+Python~3.7.3} combinations.
